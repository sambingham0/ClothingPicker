...
**ClothingPicker** is a web-based personal stylist inspired by the movie *Clueless*. It helps users organize their wardrobe, upload clothing images, and receive outfit recommendations based on matching algorithms, weather, and more.

## Features

-   **Wardrobe Management:** Upload and categorize clothing items by type, color, season, and fit.
...
-   Smarter outfit matching (weather API integration, style rules)
